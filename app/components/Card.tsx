 ...
 */
function _Card(props: CardProps) {
  const {
    content,
    contentTx,
    contentTxOptions,
...
export const Card = styled<CardProps, "headingStyle" | "contentStyle" | "footerStyle", any>(_Card, {
  props: {
    headingStyle: true,
    contentStyle: true,
    footerStyle: true,
...
const $containerPresets = {
  ...
  reversed: [
    $containerBase,
    { backgroundColor: colors.primary[800], borderColor: colors.primary[500] },
  ] as StyleProp<ViewStyle>,
}

const $headingPresets: Record<Presets, TextStyle> = {
  default: {},
  reversed: { color: colors.primary[100] },
}
